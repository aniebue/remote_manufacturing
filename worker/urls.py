...
urlpatterns = [
    ...
    path('worker/ajax-serviceman-chat/<str:expert_id>/<str:req_id>', views.ajax_serviceman_chat, name='ajax_serviceman_chat'),
    path('worker/ajax-post-serviceman-chat/<str:expert_id>/<str:req_id>', views.ajax_post_serviceman_chat, name='ajax_post_servicema_chat'),
